...
for edges in (
    ...
    reduced_graph.dump_nodes(os.path.join(edges_string, f"go_nodes_training_{edges_string}.tsv"))

    pos_training.dump_edges(os.path.join(edges_string, f"go_edges_training_{edges_string}.tsv"))
    pos_validation.dump_edges(os.path.join(edges_string, f"go_edges_validation_{edges_string}.tsv"))
    neg_training.dump_edges(os.path.join(edges_string, f"go_edges_neg_training_{edges_string}.tsv"))
    neg_validation.dump_edges(os.path.join(edges_string, f"go_edges_neg_validation_{edges_string}.tsv"))
    os.system(f"sed -i 's/$/\tlabel/' {edges_string}/go_edges_neg_training_{edges_string}.tsv")
    os.system(f"sed -i 's/$/\tlabel/' go_edges_neg_validation_{edges_string}.tsv")
