...
class TestGraphEmbedding(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.expected_embedding_file = "tests/resources/test_output_data_dir/test_embeddings_test_yaml.csv"
        ...
        self.node_embed_args = {
            ...
            "embedding_history_outfile": "tests/resources/test_output_data_dir/embedding_history.json",
            "main_graph_args": {
                "directed": False,
                "node_path": "tests/resources/test_graphs/test_small_nodes_with_text.tsv",
